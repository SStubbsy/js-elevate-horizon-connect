...
## Core Features
    ...
    Event search — Keyword search and filtering for quick discovery.

    Event details — Full event information including capacity, time, and location.

    Event registration — Users can register for events with confirmation messaging.

    Accessibility options — Adjustable text size, dark mode, and sound toggle.

    Offline support — Local storage caching for offline browsing.
